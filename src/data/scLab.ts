...
export const JOURNEY_STOPS: JourneyStop[] = [
  {
    id: "taiwan",
    coords: [121, 23.5],
    headline: "Built Mandarin and cultural fluency",
    label: "Taiwan",
    title: "Language & Cultural Fluency",
    description: "Living in Taiwan developed the language skills, cultural literacy, and adaptability that later strengthened supplier relationships and international operations.",
    year: "2012",
  },
  {
    id: "china",
    coords: [104, 35],
    headline: "Developed sourcing and supplier expertise",
    label: "China",
    title: "Ground-Level Sourcing",
    description: "Real-world sourcing experience gave me practical exposure to supplier management, operations, and procurement processes.",
    year: "2016",
  },
  {
    id: "new-york",
    coords: [-74, 40.7],
    headline: "Developed Fortune 100 operational experience",
    label: "New York",
    title: "Fortune 100 Procurement",
    description: "Worked across procurement, finance, and legal to support vendor onboarding, contract coordination, and large-scale operational launches.",
    year: "2022",
  },
  {
    id: "se-asia",
    ...
    description: "Managed supplier data, onboarding, and compliance systems supporting global manufacturing and traceability operations.",
    year: "2023–2024",
  },
];
